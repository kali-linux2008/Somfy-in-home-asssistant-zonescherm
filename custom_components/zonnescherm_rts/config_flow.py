...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                await api.discover()
                await self.async_set_unique_id(f"zonnescherm_{api.server_id}")
    ...
    async def async_step_zeroconf(
        ...
        await self.async_set_unique_id(f"zonnescherm_{self.server_id}")
...
class ESPSomfyOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        """Configure options for zonnescherm_rts."""
        errors = {}
        if user_input is not None:
            try:
